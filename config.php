...
// HTTP
define('HTTP_SERVER', 'http://localhost/my-web/opencart.3020/');

// HTTPS
define('HTTPS_SERVER', 'http://localhost/my-web/opencart.3020/');

// DIR
define('DIR_APPLICATION', 'C:\xampp\htdocs\my-web\opencart.3020/catalog/');
